...
counters_format = {
    ...
    "unique_blocked_ip": {"type": AVERAGE},
    "unique_blocked_uri": {"type": AVERAGE},
    "unique_blocked_user_agent": {"type": AVERAGE},
    "unique_blocked_asn": {"type": AVERAGE},
    "unique_blocked_country": {"type": AVERAGE},
